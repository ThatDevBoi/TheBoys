...
namespace Doozy.Installer
{
    public static class DefineSymbolsUtils
    {
        ...
        public static void AddGlobalDefine(string id)
        {
            ...
            if (!flag) return;
            Debug.Log(string.Format("Added global define \"{0}\" to {1} BuildTargetGroups", id, num));
        }
        ...
        public static void RemoveGlobalDefine(string id)
        {
            ...
            StringBuilderContainer.Length = 0;
            if (!flag) return;
            Debug.Log(string.Format("Removed global define \"{0}\" from {1} BuildTargetGroups", id, num));
        }
